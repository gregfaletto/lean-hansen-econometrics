...
residual lemmas also isolate the Hilbert-space variance algebra needed for the
arbitrary-estimator theorem.  They are not the full arbitrary-unbiased-estimator
lower bound of Hansen Theorem 6.11 because the theorem-specific orthogonality
discharge remains missing.
