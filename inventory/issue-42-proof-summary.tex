...
to clusterwise block dominance.  This
...
identities; raw CR3 middle-moment identification needed to construct the
conditional CR3 block covariances from primitive cluster error assumptions. \\
