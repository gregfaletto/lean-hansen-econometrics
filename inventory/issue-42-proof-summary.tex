...
\date{Branch \lean{codex/issue-42-ch7-unblocked}, head \lean{f2c9972}, May 9, 2026}
...
average-treatment-effect story.  The branch does not add pointwise density
notation $ACE(x)$.
...
\lean{TendstoInDistribution.integral_tendsto_of_realClip_tails}.
...
iid observations.  They are not the full arbitrary-unbiased-estimator lower
bound of Hansen Theorem 6.11.
...
Area & Remaining work \\
\midrule
Chapter 2 & Optional pointwise $ACE(x)$ notation and a literal
$m(1,x)-m(0,x)$ surface beyond the current a.e. variable-facing CATE and
observed-regression wrappers. \\
...
discharge for Theorems 6.4 and 6.5; a.s.-continuity version of the CMT in
distribution for Theorem 6.7; arbitrary-unbiased-estimator lower bound for
Theorem 6.11; deriving the weak-convergence UI tail premise in Theorem 6.15
directly from Mathlib \lean{UniformIntegrable}. \\
Chapter 7 & Further tightening of some public condition packages to the literal
textbook iid/moment assumptions; concrete cumulant/polynomial Edgeworth
