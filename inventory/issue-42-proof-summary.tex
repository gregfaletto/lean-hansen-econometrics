...
\lean{IidRobustFeasibleHCMomentConditions}. The combined robust feasible-HC
...
literal textbook response fourth-moment assumption; concrete high-moment
cumulant expansion for Theorem 7.15. \\
\bottomrule
\end{longtable}
