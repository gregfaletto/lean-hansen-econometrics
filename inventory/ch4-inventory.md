...
PSD theorem for that CR3-style estimator. The multi-observation cluster block layer now also has the
...
- [olsClusteredCR3VarianceEstimator_posSemidef](../../HansenEconometrics/Chapter4LeastSquaresRegression.lean#L735): CR3-style clustered covariance estimator is PSD.
