...
the equation (4.54) covariance estimator, and a PSD theorem for that CR3-style estimator.
...
- CR3 leave-cluster-out coefficient identity (4.53) and conditional conservativeness theorem
...
- [olsClusteredCR3VarianceEstimator_posSemidef](../../HansenEconometrics/Chapter4LeastSquaresRegression.lean#L413): CR3-style clustered covariance estimator is PSD.
