...
- partial — load-bearing Mathlib + AsymptoticUtils backing in place; #41 added Delta-method,
  smooth-function, norm-tightness, law-relabeling, and UI tail-control proof-engine wrappers
...
- **#41 update:** Theorems 6.8, 6.9, and 6.10 now have proof-engine Lean wrappers; Definition 6.4 and Theorem 6.16 have a Mathlib UI tail-control and power-scale maximum wrapper. The full textbook 6.16 proof still needs the finite maximum inequality discharged from the explicit `hmax` hypothesis.
