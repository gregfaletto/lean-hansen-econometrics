...
| Definition 6.4 uniform integrability | $Z_n$ is uniformly integrable if $\lim_{M \to \infty} \limsup_{n \to \infty} \mathbb{E}[\lVert Z_n \rVert 1\{\lVert Z_n \rVert > M\}] = 0$ | [Mathlib `UniformIntegrable`](../.lake/packages/mathlib/Mathlib/MeasureTheory/Function/UniformIntegrable.lean#L73) plus [uniformIntegrable_tail_eLpNorm_one](../HansenEconometrics/AsymptoticUtils/MaxBounds.lean#L37) as the Chapter 6 tail-control face. |
...
| Theorem 6.16 uniform stochastic bounds for maxima | If $\lvert Y_i \rvert^r$ is uniformly integrable, then $n^{-1/r} \max_{1 \le i \le n} \lvert Y_i \rvert \xrightarrow{p} 0$ | [maxNNNorm](../HansenEconometrics/AsymptoticUtils/MaxBounds.lean#L22), [scaledMaxNNNorm](../HansenEconometrics/AsymptoticUtils/MaxBounds.lean#L29), and [max_norm_scaled_tendstoInMeasure_zero_of_uniformIntegrable_norm_r](../HansenEconometrics/AsymptoticUtils/MaxBounds.lean#L196) — direct power-scale theorem for `Z_i = |Y_i|^r`; private same-file lemmas discharge the finite maximum, Markov, and union-bound steps. |
...
- **#41 update:** Theorems 6.8, 6.9, and 6.10 now have Lean wrappers; Definition 6.4 and Theorem 6.16 have a Mathlib UI tail-control layer and a direct power-scale maximum theorem. The finite maximum inequality is discharged in `MaxBounds.lean`; the displayed textbook root form remains a continuous-mapping corollary rather than a separate public wrapper.
