...
| 06 | A Review of Large Sample Asymptotics | partial | WLLN, CLT (via Cramér–Wold), CMT in probability, O_p/o_p, Slutsky, Delta-method proof-engine wrappers, smooth-function asymptotic wrappers, and UI tail-control layer backed by Mathlib + AsymptoticUtils; remaining full textbook wrappers tracked in #41 follow-ups |
