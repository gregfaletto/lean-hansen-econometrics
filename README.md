...
| 06 | A Review of Large Sample Asymptotics | partial | WLLN, CLT (via Cramér–Wold), CMT in probability, O_p/o_p, Slutsky, Delta-method wrappers, smooth-function asymptotic wrappers, UI maximum bounds for 6.16, iid finite-power-moment UI discharge, and the convergence-in-measure/Vitali face of 6.15 backed by Mathlib + AsymptoticUtils; remaining textbook-shaped gaps documented in the Ch 6 inventory |
| 07 | Asymptotic Theory for Least Squares | partial | Theorems 7.1-7.5 have totalized/ordinary OLS consistency, score CLT, vector CLT, and variance/covariance consistency wrappers; 7.6-7.14 have robust covariance, nonlinear Delta, t/CI/Wald wrappers at the current assumption layer; 7.16 and 7.17 have max-residual/max-leverage rate packaging with iid finite-squared-row-moment UI discharge; assumption-package tightening and Edgeworth remain |
