...
| 03 | The Algebra of Least Squares | partial | OLS algebra + projection/annihilator (incl. rank), leverage identities/bounds, reduced-Gram leave-one-out formulas, influence identities, and FWL coefficient/residual core landed |
